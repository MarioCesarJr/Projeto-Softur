...
<%@page import="softur.entities.Funcionario"%>
<%@page import="softur.repository.Funcionarios"%>
		...
		<table id="tabela" class="table table-striped table-bordered">
			...
			<tbody>
				...
				<%
					...
					try {
						Funcionarios funcionarios = new Funcionarios(manager);
				...
				<tr>
					...
					<td><%=new SimpleDateFormat("dd/MM/yyyy").format(funcionario.getDataAdmissao())%></td>
					<td><%=NumberFormat.getCurrencyInstance().format(funcionario.getSalario())%></td>
					<td><%=funcionario.getComplemento()%></td>
				</tr>
				</div>
				<%
					}
